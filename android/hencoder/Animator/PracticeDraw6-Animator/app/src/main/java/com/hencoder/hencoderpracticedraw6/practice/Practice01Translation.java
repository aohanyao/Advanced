...
public class Practice01Translation extends RelativeLayout {
    ...
    int translationStateCount = SDK_INT > Build.VERSION_CODES.LOLLIPOP ? 7 : 5;
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (clickCount) {
                    ...
                    case 1:
                        imageView.animate().translationX(150);
                        break;
                    case 2:
                        imageView.animate().translationX(0);
                        break;
                    case 3:
                        imageView.animate().translationY(150);
                        break;
                    case 4:
                        imageView.animate().translationY(0);
                        break;
                    case 5:
                        imageView.animate().translationZ(30);
                        break;
                    case 6:
                ...
                if (clickCount == translationStateCount) {
                    clickCount = 1;
                }
            }
        });
